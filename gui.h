...
#define MEMORY_WINDOW_SIZE_VERTICAL 12


#define AO_WINDOW_SIZE_HORIZONTAL 9
#define AO_WINDOW_SIZE_VERTICAL 3
#define AO_WINDOW_VERTICAL_OFFSET 22 // memory vertical + 2 gap

#define COMMAND_WINDOW_SIZE_HORIZONTAL 20
#define COMMAND_WINDOW_SIZE_VERTICAL 10
#define COMMAND_WINDOW_VERTICAL_OFFSET 27 // ao offset + 1 gap
